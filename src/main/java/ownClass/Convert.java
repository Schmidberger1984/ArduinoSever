...
public class Convert {
    ...
    double datatemp;
    double datahumid;
    private static final int[] RESISTANCE ={510,562,617,674,736,802,872,946,985,1024,1106,1190,1280,1373,1469,1570,1674,1782,1894,2010,2096,2201};
    private static final int[] GRAD ={-50,-40,-30,-20,-10,0,10,20,25,30,40,50,60,70,80,90,100,110,120,130,140,150};
